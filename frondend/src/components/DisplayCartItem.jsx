...
import imageEmpty from '../assets/NoData.jpg'
                    ...
                    cartItem[0] ? (
                        <>
                            <div className='flex items-center justify-between px-4 py-2 bg-blue-100 text-blue-500 rounded-full'>
                                    ...
                                    <p>{DisplayPriceSlRupees(notDiscountTotalPrice - totalPrice )}</p>
                            </div>
                                                ...
                                                return(
                                                    <div key={item?._id+"cartItemDisplay"} className='flex  w-full gap-4'>
                                                        ...
                                                        <div className='w-full max-w-sm text-xs'>
                                                            ...
                                                            <p className='font-semibold'>{DisplayPriceSlRupees(pricewithDiscount(item?.productId?.price,item?.productId?.discount))}</p>
                                                        </div>
                                                        <div>
